<?php
 ...
 class Users {
	 ...
	 /*DO: connstruct the connfcode. Find out why gender, accomidations and dinepref are already set */
	 
	 public function __connstruct( $data = array() ) {
	 ...
	 public function register() {  
		$correct = false;
			try {
				...
				$stmt->execute();
				return "Registration Successful <br/> <a href='index.php'>Login Now</a>";  /*change this */
			}catch( PDOException $e ) {
				return $e->getMessage();
			}
	 }
